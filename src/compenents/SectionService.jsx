            ...
            <hr class="diviseur bg-warning mb-5"></hr>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="card-body text-center">
                        <p class="card-title text-center"><i class="icone fas fa-code fa-5x"></i></p>
                ...
                <div class="col-lg-3">
                    <div class="card border-white">
                    <div class="card-body text-center">
                        <p class="card-title text-center"><i class="icone fas fa-pencil-alt fa-5x"></i></p>
                        {/* <p class="card-text text-center">With supporting text below as a natural lead-in to additional content.</p> */}
                ...
                <div class="col-lg-3">
                    <div class="card border-white">
                    <div class="card-body text-center">
                        <p class="card-title text-center"><i class="icone fas fa-tools fa-5x"></i></p>
                        {/* <p class="card-text text-center">With supporting text below as a natural lead-in to additional content.</p> */}
                ...
                <div class="col-lg-3">
                    <div class="card border-white">
                    <div class="card-body text-center">
                        <p class="card-title text-center"><i class="icone fas fa-mobile-alt fa-5x"></i></p>
                        {/* <p class="card-text text-center">With supporting text below as a natural lead-in to additional content.</p> */}
